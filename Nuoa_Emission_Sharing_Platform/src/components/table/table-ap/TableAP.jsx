...
function TableAP() {
    ...
    const data = [
        { id: 'abc1', productId: 'Product ID', productName: 'Product Name', dataOwner: 'Data Owner', version: 'Version', dateProcessed: 'Date Processed' },
        // Add more rows as needed
        { id: 'abc11', productId: 'Product ID', productName: 'Product Name', dataOwner: 'Data Owner', version: 'Version', dateProcessed: 'Date Processed' },
        { id: 'abc12', productId: 'Product ID', productName: 'Product Name', dataOwner: 'Data Owner', version: 'Version', dateProcessed: 'Date Processed' },
        { id: 'abc11', productId: 'Product ID', productName: 'Product Name', dataOwner: 'Data Owner', version: 'Version', dateProcessed: 'Date Processed' },
        { id: 'abc12', productId: 'Product ID', productName: 'Product Name', dataOwner: 'Data Owner', version: 'Version', dateProcessed: 'Date Processed' },
    ];
    ...
    const renderRows = () => {
        ...
        return data.slice(startIndex, endIndex).map((row, index) => (
            <tr key={index} className='border hover:bg-slate-200 border-b-black px-4 py-2 font-medium'>
                ...
                <td className='p-3'><button className="text-blue-500 underline">Request Access</button></td>
            </tr>
        ));
    };
